//Дана бесконечная последовательность , сотовленная рандомно из символов a,b,c.Реализовать генератор псевдослучайной последовательности из символов и подсчитать кол-во триад aaa, bbb, ccc, каждые триады считать отдельно.
#include "stdafx.h"
#include <conio.h>
#include<iostream>
#include <stdio.h>
